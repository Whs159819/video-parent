    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse"
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="${pageContext.request.contextPath}/speaker/speakerList">主讲人管理</a></li>
...
<div class="container">
    <div class="navbar-right" style="padding-right: 17px">
        <abyg:page url="${pageContext.request.contextPath}/speaker/speakerList.action"></abyg:page>
    </div>
</div>
</body>
