        ...
        function delSpeakerById(Obj, id, name) {
            ...
            Confirm.show('温馨提示：', '确定要删除' + name + '么？', {
                'Delete': {
                    ...
                    'callback': function () {
                        var param = {"id": id};
                        $.post("${pageContext.request.contextPath}/course/delete", param, function (data) {
                            if (data == 'success') {
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse"
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="${pageContext.request.contextPath}/course/courseList">课程管理</a></li>
...
<div class="container">
    <div class="navbar-right" style="padding-right: 17px">
        <abyg:page url="${pageContext.request.contextPath}/course/courseList.action"></abyg:page>
    </div>
</div>
</body>
