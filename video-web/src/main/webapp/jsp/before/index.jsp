...
<header>
    <div class="container">
        ...
        <a onclick="pyRegisterCvt()" target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=1041121185&site=qq&menu=yes"><img
...
<nav class="w100">
    <div class="container">
        <img src="${pageContext.request.contextPath}/img/logo.png" alt="Y先生教育的logo"
             onclick="location.href='${pageContext.request.contextPath}/jsp/before/index.jsp'" draggable="false">
