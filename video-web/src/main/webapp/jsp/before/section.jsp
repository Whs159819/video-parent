...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            //通过ajax更新播放次数
            var params = {"id":"${video.id}", "play_num":"${video.play_num}"};
...
<nav class="w100">
    <div class="container">
        <img src="${pageContext.request.contextPath}/img/logo.png" alt="Y先生教育的logo" onclick="location.href='${pageContext.request.contextPath}/jsp/before/index.jsp'"
             draggable="false">
        ...
        <div class="container">
            ...
            <c:forEach items="${course.videoList}" var="video">
                <div class="chapter" onclick="load(${video.id})">
                    <p class="biaoti"><a
                            href="showVideo?video_id=${video.id}&subject_name=${subject_name}">${video.title}</a></p>
